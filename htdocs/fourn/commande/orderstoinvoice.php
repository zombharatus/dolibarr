...
<?php
	...
	$sql .= " AND c.fk_statut IN (".CommandeFournisseur::STATUS_RECEIVED_COMPLETELY.",".CommandeFournisseur::STATUS_RECEIVED_PARTIALLY.")";		// Must match filter in htdocs/fourn/card.php
	$sql .= " AND c.billed = 0";
